...
- **Dataset (.h5ad)** — full path to the AnnData file to visualize. **Required** — cellxgene will
  not start without one. Defaults to a small bundled example dataset; point it at your own `.h5ad`.
